#E1006
# normalizo variables en pesos con promedio dolar mensual
...
kscript <- "E1006_751_lgb_bin2_histcorregido"

karch_dataset <- "~/buckets/b1/datasets/2021-10-03_corr_ord_nojune_usd.csv.gz"
...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.07, upper = 0.2),
...
dtrain <- lgb.Dataset(
  data = data.matrix(dataset[foto_mes >= kmes_train_desde & foto_mes <= kmes_train_hasta, campos_buenos, with = FALSE]),
