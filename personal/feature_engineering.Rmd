...
```{r}
fwrite("./datasets/paquete_premium_corregido_ordered_nojune.csv.gz")
```
...
```{r}
fwrite("./datasets/corr_ord_nojune_usd.csv.gz")
```
...
dataset[, paste("norm", cols, sep = "_") := map(.SD, norm), by = foto_mes, .SDcols = cols]
```
