...
karch_dataset    <- "./datasets/dataset_stacking_v002.csv.gz"   #este dataset se genero en el script 811_dataset_epic.r
...
campos_malos  <- c("foto_mes", "numero_de_cliente")   #aqui se deben cargar todos los campos culpables del Data Drifting

ksemilla_azar  <- 123801  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
